...
This is a fully static site. You can open `index.html` directly in a browser, or serve it locally:
...
### GitHub Pages
1. Create a new GitHub repository and push all files in this folder to it (including the `assets/` folder).
